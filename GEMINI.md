...
### 3. Messaging & Scraping (`src/services/gmail.service.ts`, `src/services/sway.service.ts`, `src/services/beeper.service.ts`)
...
7.  **Output**: Generate a cited, child-specific parenting plan in Markdown format.
